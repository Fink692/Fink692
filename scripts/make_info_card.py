...
# ===========================================================================
HOST = "Fink692"   # shown as  Fink692@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "Building Quant Systems Lab"),
    ("kv", "Focus", "Derivatives · risk · microstructure"),
    ("kv", "Mode", "Simulation-heavy research software"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Research", "Python · NumPy · SciPy"),
    ("kv", "Models", "Stochastic vol · factors · credit"),
    ("kv", "Systems", "CLI · tests · reproducible SVG"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "170 automated tests with CI"),
    ("bul", "Risk-aware trading research"),
]
